<template>
  <a-layout id="components-layout-demo-side" theme="light"  style="min-height: 100vh">
    <a-layout-sider v-model="collapsed" collapsible>
      <img style="height:70px ; width:100%" src="https://curacaoliqueur.spin-cdn.com/182/14/1564/image/format_website_edit_5bdb59053e5da.jpg" alt="">
      ...
      <img style="height:60% ; width:100%" src="https://www.gobourbon.com/wp-content/uploads/2019/03/EFCCF7C6-0A6F-4658-83B6-877007B0A1AC-751x1024.jpeg" alt="">
    <a-layout>
      ...
      <a-layout-footer class="footer" :style="{height: '5vh',color:'white' ,background: 'black', textAlign:'center'}">
